...
export default async function LeaderboardOffPage() {
  ...
  const [{ data: categorias }, { data: duplas }, { data: provas }, { data: resultados }] =
    await Promise.all([
  ...
  return (
    <main>
      <div className="mb-6">
        <h1 className="font-display text-2xl font-bold text-navy">Leaderboard Off</h1>
        <p className="mt-1 text-sm text-steel-600">
          Visão interna do organizador — inclui provas ainda não publicadas.
        </p>
      </div>
